...
why this project, why this problem is interesting
outline of the rest of the report
should include general ideas, not technical ones, so details about data cleaning and tokenization - are not here -->
...
There a various frameworks, which help in creating UI, from which we decided to use [Flask](https://flask.palletsprojects.com/en/3.0.x/) and [Gradio](https://www.gradio.app). The latter allows for frendly web interface, easly integrated into Jupyter notebook and therefore live streaming of the answer generated by our solution.
...
<!-- about the project, details about pipeline (RAG, UI, Docker) - but we can write that the details on how to install are in readme, to make it more readable in the report
show that we understand what methods we used -->
